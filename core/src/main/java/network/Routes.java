...
public final class Routes {
    public static final String API_HOST = "nationsapi.fly.dev";
    ...
    //not secret
    public static final String SERVER_SECRET = "Bearer SERVER_SECRET_NOT_SO_SECRET_LIKE_THIS_THOUGH_HOPEFULLY_IWILL_USE_ENV_LATER"; //i forgot
}
